...
xfail_reason() {
  case "$1" in
    ...
    lean_spec.subspecs.networking.discovery.crypto) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.discovery.keys) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.discovery.handshake) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.discovery.codec) echo "#10 imports discovery chain" ;;
    lean_spec.subspecs.networking.discovery.config) echo "#10 imports discovery chain" ;;
    lean_spec.subspecs.networking.discovery.messages) echo "#10 imports discovery chain" ;;
    lean_spec.subspecs.networking.discovery.packet) echo "#10 imports discovery chain" ;;
    lean_spec.subspecs.networking.discovery.routing) echo "#10 imports discovery chain" ;;
    lean_spec.subspecs.networking.discovery.session) echo "#10 imports discovery chain" ;;
    lean_spec.subspecs.networking.enr.enr) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.enr.eth2) echo "#10 imports enr chain" ;;
    lean_spec.subspecs.networking.enr.keys) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.transport.identity.keypair) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.transport.identity.signature) echo "#10 cryptography lib" ;;
    lean_spec.subspecs.networking.transport.peer_id) echo "#10 imports identity chain" ;;
    lean_spec.subspecs.networking.transport.protocols) echo "#10 imports transport chain" ;;
    lean_spec.subspecs.networking.peer) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.config) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.types) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.varint) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.reqresp.codec) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.reqresp.handler) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.reqresp.message) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.mcache) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.mesh) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.message) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.parameters) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.rpc) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.topic) echo "#10 imports networking chain" ;;
    lean_spec.subspecs.networking.gossipsub.types) echo "#10 imports networking chain" ;;
    # #11: sqlite3
    lean_spec.subspecs.storage.sqlite) echo "#11 sqlite3" ;;
    lean_spec.subspecs.storage.database) echo "#11 imports storage chain" ;;
    lean_spec.subspecs.storage.exceptions) echo "#11 imports storage chain" ;;
    lean_spec.subspecs.storage.namespaces) echo "#11 imports storage chain" ;;
    # #10,#7: sync modules (depend on networking chain + asyncio)
    lean_spec.subspecs.sync.block_cache) echo "#7,#10 imports sync chain" ;;
    lean_spec.subspecs.sync.config) echo "#7,#10 imports sync chain" ;;
    lean_spec.subspecs.sync.peer_manager) echo "#7,#10 imports sync chain" ;;
    lean_spec.subspecs.sync.states) echo "#7,#10 imports sync chain" ;;
    # #12: aioquic
    lean_spec.subspecs.networking.transport.quic.tls) echo "#10,#12 aioquic + cryptography" ;;
